...
import '../../views/widgets/posts/single_post/single_post_sceen_wd.dart';
...
var appRoutes = [
  ...
  // notifications
  GetPage(
      name: '/notifications/announcement',
  ...
  GetPage(
      ...
      page: () => const ProfileActionsScreen(),
      middlewares: [AuthMiddleware()]),
  GetPage(
      name: '/profile',
