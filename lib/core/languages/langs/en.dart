const Map<String, String> en = {
  ...
  'load': 'Load...',
  'report': 'Report',
  'post_has_been_reported': 'Post has been reported',
  'download': 'Download',
  'copy_link': 'Copy Link',
  ...
  'feed': 'Feed',
  'no_post_to_display': 'No post to display',
  'success': 'Success',
  ...
  'video_duration_should_be_between_45sec_to_3_min':
      'Video duration should be between 45sec \n to 3 min and less than 100MB',
  'invalid_video_duration': 'Invalid video duration',
  'video_duration': 'Video duration: ',
  'video_description': 'Video description',
  'video_description_is_required': 'Video description is required',
  'no_category_to_select': 'No category to select',
  'add_tags': 'Add tags',
  'no_tags': 'No tags',
...
// 04/10/2023
  ...
  'ok': 'Ok',
  'warning': 'Warning',
  'your_video_will_be_ready_soon': 'Your video will be ready soon',
};
