const Map<String, String> ru = {
  ...
  // 01/08/2023
  'profile_actions': 'Действия профиля',
  'sign_out': 'Выйти',
  'profile': 'Профиль',
  ...
  'load': 'Загрузка...',
  'report': 'Сообщить',
  'post_has_been_reported': 'Пост был сообщен',
  'download': 'Скачать',
  'copy_link': 'Копировать ссылку',
  'edit_profile': 'Редактировать профиль',
  'name': 'Имя',
  'please_enter_your_name': 'Пожалуйста, введите свое имя',
  'bio': 'Биография',
  'please_enter_your_bio': 'Пожалуйста, введите свою биографию',
  'update_profile': 'Обновить профиль',
  'feed': 'Лента',
  'no_post_to_display': 'Нет постов для отображения',
  'success': 'Успех',
  'video_downloaded_successfully': 'Видео успешно загружено',
  'error': 'Ошибка',
  'error_downloading_video': 'Ошибка загрузки видео',
  ...
  'video_description_is_required': 'Описание видео обязательно',
  'no_category_to_select': 'Нет категории для выбора',
