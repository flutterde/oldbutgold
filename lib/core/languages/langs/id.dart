const Map<String, String> id = {
  ...
  'load': 'Memuat...',
  'report': 'Laporkan',
  'post_has_been_reported': 'Postingan telah dilaporkan',
  'download': 'Unduh',
  ...
  'bio': 'Biografi',
  'please_enter_your_bio': 'Silakan masukkan biografi Anda',
  'update_profile': 'Perbarui Profil',
  'feed': 'Feed',
  'no_post_to_display': 'Tidak ada postingan untuk ditampilkan',
  'success': 'Berhasil',
  'video_downloaded_successfully': 'Video berhasil diunduh',
  'error': 'Kesalahan',
  'error_downloading_video': 'Kesalahan saat mengunduh video',

  // Auth
  'login': 'Masuk',
  'register': 'Daftar',
  'enter_your_email': 'Masukkan email Anda',
  'please_enter_your_email': 'Silakan masukkan email Anda',
  ...
  'video_description_is_required': 'Deskripsi video diperlukan',
  'no_category_to_select': 'Tidak ada kategori untuk dipilih',
