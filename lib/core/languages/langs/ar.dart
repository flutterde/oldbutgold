const Map<String, String> ar = {
  // 01/08/2023
  'profile_actions': 'إجراءات الملف الشخصي',
  ...
  'load': 'تحميل...',
  'report': 'تقرير',
  'post_has_been_reported': 'تم الإبلاغ عن المنشور',
  'download': 'تحميل',
  ...
  'error': 'خطأ',
  'error_downloading_video': 'حدث خطأ أثناء تحميل الفيديو',
  ...
  'video_description_is_required': 'وصف الفيديو مطلوب',
  'no_category_to_select': 'لا يوجد فئة للاختيار من بينها',
...
'check_profile': 'تحقق من الملف الشخصي',
'Followers_': 'متابعون',
'Following_': 'يتابع',
'posts': 'منشورات:',
...
'follow': 'متابعة',
  ...
  // Onboarding
  'welcome': 'مرحبًا بك في قديم ولكن ذهبي!',
  'onboarding_1_description': 'اكتشف وشارك مقاطع الفيديو الخالدة من الماضي. استكشف عالم الحنين والإبداع.',
  'onbo_title2': 'استكشاف مقاطع الفيديو الكلاسيكية',
  'onboarding_2_description': 'انتقل عبر مجموعة واسعة من مقاطع الفيديو القصيرة التي تمتد عبر عصور مختلفة. من اللحظات الكلاسيكية إلى الجواهر المنسية، ابحث عن أفضل ما في الماضي.',
  'onbo_title3': 'التواصل مع المجتمع',
  'onboarding_3_description': 'انضم إلى مجتمع من الهواة المشتركين. اتبع مبدعيك المفضلين، واترك تعليقات، وشارك أفكارك حول مقاطع الفيديو التي تلامس قلبك.',
  'onbo_title4': 'حفظ والإبلاغ',
  'onboarding_4_description': 'احفظ مقاطع الفيديو المفضلة لديك لاحقًا، أو قدم تقريرًا عن المحتوى الذي ينتهك إرشادات مجتمعنا. مساهمتك تساعد في الحفاظ على قديم ولكن ذهبي آمنًا وممتعًا للجميع.',
  'choose_lange': 'اختر اللغة',
